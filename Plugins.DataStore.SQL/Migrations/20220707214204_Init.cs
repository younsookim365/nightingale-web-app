    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Type of livestock", "Livestock" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "Description", "Name" },
                values: new object[] { 2, "Type of meat", "Meat" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "CategoryId", "Description", "Name" },
                values: new object[] { 3, "Type of animal feed", "Animal Feed" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Cow", 12000.0, 100 },
                    { 2, 1, "Pig", 3000.0, 150 },
                    { 3, 2, "Brisket", 99.989999999999995, 300 },
                    { 4, 2, "Pork Belly", 79.989999999999995, 170 }
                });
